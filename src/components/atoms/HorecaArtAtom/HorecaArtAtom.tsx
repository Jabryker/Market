...
export const HorecaArtAtom: FC = () => {
  return (
    <div className="flex flex-row justify-between items-center m-20">
      ...
      <div className="rounded-lg border-3 border-[#EC9A1E] bg-[#EC9A1E] p-4 w-[900px] h-[400px] flex flex-col justify-center items-start">
        <div className="text-white text-left ml-20">
          ...
          <button className="bg-white text-[#EC9A1E] border-r py-2 px-4 transition duration-300 hover:bg-[#EC9A1E] hover:text-white">
                        Подробнее
          </button>
        </div>
      </div>
